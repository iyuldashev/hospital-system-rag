...
Welcome to the Hospital Retrieval-Augmented Generation (RAG) chatbot project! This project integrates cutting-edge technologies to provide intelligent, data-driven responses for hospitals, patients, physicians, and administrative queries.
...
The chatbot uses OpenAI LLMs, so you'll need to create an [OpenAI API key](https://platform.openai.com/api-keys) and store it as `OPENAI_API_KEY`. 
